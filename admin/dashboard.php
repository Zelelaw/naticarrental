...
if (strlen($_SESSION['alogin']) == 0) {
    ...
    <head>
        ...
        <title>Nati Car Rental, Addis Ababa Ethiopia | Admin Dashboard</title>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <div class="panel panel-default">
                                            ...
                                            <a href="manage-vehicles.php" class="block-anchor panel-footer text-center">Full
                                    ...
                                    <div class="col-md-3">
                                        <div class="panel panel-default">
                                            ...
                                            <a href="new-bookings.php" class="block-anchor panel-footer text-center">Full
                                                Detail &nbsp; <i class="fa fa-arrow-right"></i></a>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
