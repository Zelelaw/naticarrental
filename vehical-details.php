...
<head>
  ...
  <title>Nati Car Rental, Addis Ababa Ethiopia | Vehicle Details</title>
  <!--Bootstrap -->
          ...
          <div class="listing_detail_head row">
            ...
            <div class="col-md-3">
              <div class="price_info">
                <p><?php echo htmlentities($result->PricePerDay); ?> </p> Br/Day
          ...
          <?php }
            ...
            <aside class="col-md-3">
              ...
              <div class="share_vehicle">
                <p>Share: <a href="https://www.facebook.com/NatiCarSales?mibextid=LQQJ4d" target="_blank">
                    <i class="fa-brands fa-facebook"></i></a> <a href="https://t.me/NaticarRental" target="_blank">
                    <i class="fa-brands fa-telegram"></i></a>
                  <a href="https://www.tiktok.com/@nati_0825?_t=8Yh6Zmo5YaD" target="_blank">
                    <i class="fa-brands fa-tiktok"></i></a>
                  <a href="https://www.instagram.com/invites/contact/?i=14kqnasibfock&utm_content=2kztz23" target="_blank">
              ...
              <div class="sidebar_widget">
                ...
                <form method="post">
                  <div class="form-group">
                    ...
                    <input type="char" class="form-control" name="fullname" placeholder="Full Name" required>
                  </div>
                  <div class="form-group">
                    <label>Full Name:</label>
                  ...
                  <div class="col-md-3 grid_listing">
                    <div class="product-listing-m gray-bg">
                      ...
                      <div class="product-listing-content">
                        ...
                        <p class="list-price"><?php echo htmlentities($result->PricePerDay); ?> Br/Day</p>
